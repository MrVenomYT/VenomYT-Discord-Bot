...
module.exports = {
    ...
    run: async (bot, message, args) => {
        try {
            if (!message.member.hasPermission("MUTE_MEMBERS")) return message.channel.send("**You Dont Have Permmissions To Mute Someone!**");

            if (!message.guild.me.hasPermission("MUTE_MEMBERS")) return message.channel.send("**I Don't Have Permissions To Mute Someone! - [MUTE_MEMBERS]**")
